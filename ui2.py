...
"background-color: #2e2e36;")
        ...
        self.icon_bottom_label.setMinimumSize(QtCore.QSize(150, 50))
        self.icon_bottom_label.setMaximumSize(QtCore.QSize(150, 50))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(9)
        font.setBold(True)
...
"}")
    ...
    def retranslateUi(self, Unframewindow):
        ...
        self.icon_bottom_label.setText(_translate("Unframewindow", "<html><head/><body><p>网络流量对抗样本<br/>生成与检测系统</p></body></html>"))
        __sortingEnabled = self.left_widget.isSortingEnabled()
        self.left_widget.setSortingEnabled(False)
        item = self.left_widget.item(0)
        item.setText(_translate("Unframewindow", "对抗流量生成"))
        item = self.left_widget.item(1)
        item.setText(_translate("Unframewindow", "对抗流量检测"))
        ...
        self.read_button.setText(_translate("Unframewindow", "生成对抗pcap"))
        self.label_4.setText(_translate("Unframewindow", "生成数量"))
        self.lineEdit_2.setText(_translate("Unframewindow", "100"))
